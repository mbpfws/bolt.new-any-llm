...
const staticModels: ModelInfo[] = [
  ...
  { name: 'nousresearch/hermes-3-llama-3.1-405b:free', label: 'hermes-3-llama-3.1-405b:free (OpenRouter)', provider: 'OpenRouter' },
  { name: 'liquid/lfm-40b:free', label: 'liquid/lfm-40b:free (OpenRouter)', provider: 'OpenRouter' },
  { name: 'llama-3.2-90b-vision-preview', label: 'llama-3.2-90b-vision-preview (Groq)', provider: 'Groq' },
  ...
  { name: 'gemini-1.5-flash-002', label: 'Google Gemini Flash 1.5-002 (Google)', provider: 'Google' },
  { name: 'gemini-1.5-pro-002', label: 'Google Gemini Pro 1.5-002 (Google)', provider: 'Google' },
